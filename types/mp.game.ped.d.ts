...
declare module mp.game {
    class ped extends mp.game.entity {
        ...
        static attachSynchronizedSceneToEntity(sceneId: number, entity: mp.game.entity, boneIndexId: number);
        static attachSynchronizedSceneToEntity(sceneId: number, entity: object, boneIndexId: number);
        ...
        static clearRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: string, group2: string);
        static clearRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: string, group2: number);
        static clearRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: number, group2: string);
        static clearRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: number, group2: number);
        static getNumParentPedsOfType(type: mp.game.ped.faceType): number;
        static getNumParentPedsOfType(type: number): number;
        ...
        static getRelationshipBetweenGroups(group1: string, group2: string): mp.game.ped.groupRelationship;
        static getRelationshipBetweenGroups(group1: string, group2: number): mp.game.ped.groupRelationship;
        static getRelationshipBetweenGroups(group1: number, group2: string): mp.game.ped.groupRelationship;
        static getRelationshipBetweenGroups(group1: number, group2: number): mp.game.ped.groupRelationship;
        static getTattooZone(collection: string, overlay: string): mp.game.ped.tattooZoneData;
        static getTattooZone(collection: string, overlay: number): mp.game.ped.tattooZoneData;
        static getTattooZone(collection: number, overlay: string): mp.game.ped.tattooZoneData;
        static getTattooZone(collection: number, overlay: number): mp.game.ped.tattooZoneData;
        ...
        static removeRelationshipGroup(groupHash: string);
        static removeRelationshipGroup(groupHash: number);
        ...
        static setRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: string, group2: string);
        static setRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: string, group2: number);
        static setRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: number, group2: string);
        static setRelationshipBetweenGroups(relationship: mp.game.ped.groupRelationship, group1: number, group2: number);
        ...
        static createPed(pedType: mp.game.ped.type, modelHash: string, x: number, y: number, z: number, heading: number, networkHandle: boolean, pedHandle: boolean): mp.game.ped;
        static createPed(pedType: mp.game.ped.type, modelHash: number, x: number, y: number, z: number, heading: number, networkHandle: boolean, pedHandle: boolean): mp.game.ped;
        ...
        static addRelationshipGroup(name: string, groupHash: string): string;
        static addRelationshipGroup(name: string, groupHash: string): number;
        static addRelationshipGroup(name: string, groupHash: number): string;
        static addRelationshipGroup(name: string, groupHash: number): number;
