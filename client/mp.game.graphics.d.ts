...
declare interface MpGameGraphics {
    ...
    world3dToScreen2d(worldX: number, worldY: number, worldZ: number, screenX: number, screenY: number): MpGameGraphicsPoint;
    ...
    getScreenActiveResolution(x: number, y: number): MpGameGraphicsSize;
    ...
    getScreenResolution(x: number, y: number): MpGameGraphicsSize;
...
declare interface MpGameGraphicsPoint {
    x: number;
    y: number;
}

declare interface MpGameGraphicsSize extends MpGameGraphicsPoint {
