...
declare interface MpGameObject {
    ...
    getStateOfClosestDoorOfType(type: string | number, x: number, y: number, z: number, locked: boolean, heading: number): MpObjectDoorState;
...
declare enum MpGameObjectPlacementColor {
    none = -1,
    red = 0,
    green = 1,
    blue = 2,
...
interface MpGameObjectDoorState {
    locked: boolean;
    heading: boolean;
}
