...
declare interface MpGamePathfind {
    ...
    getVehicleNodeProperties(x: number, y: number, z: number, density: number, flags: number): MpGamePathfindVehicleProperties;
    ...
    getStreetNameAtCoord(x: number, y: number, z: number, streetName: number, crossingRoad: number): MpGamePathfindStreetNameAtCoord;
    ...
    getNthClosestVehicleNodeFavourDirection(x: number, y: number, z: number, desiredX: number, desiredY: number, desiredZ: number, nthClosest: number, outPosition: MpVector3, outHeading: number, nodetype: MpGamePathfindNodeTypes, p10: object, p11: object): MpGamePathfindGetClosestVehicle;
    ...
    getNthClosestVehicleNodeWithHeading(x: number, y: number, z: number, nthClosest: number, outPosition: MpVector3, heading: number, unknown1: object, unknown2: number, unknown3: number, unknown4: number): MpGamePathfindGetClosestVehicleWithHeading;
    loadAllPathNodes(keepInMemory: boolean): boolean;
    getRandomVehicleNode(x: number, y: number, z: number, radius: number, p4: boolean, p5: boolean, p6: boolean, outPosition: MpVector3, heading: number): MpGamePathfindGetRandomVehicle;
    ...
    generateDirectionsToCoord(x: number, y: number, z: number, p3: object, p4: number, vehicle: MpVehicle, p6: number): MpGamePathfindGenerateDirection;
    ...
    getClosestVehicleNodeWithHeading(x: number, y: number, z: number, outPosition: MpVector3, outHeading: number, nodeType: number, p6: number, p7: number): MpGamePathfindGetClosestVehicle;
}

declare interface MpGamePathfindVehicleProperties {
    density: number;
    flags: number;
}

declare interface MpGamePathfindStreetNameAtCoord {
    streetName: number;
    crossingRoad: number;
}

declare interface MpGamePathfindGetClosestVehicle {
    outPosition: MpVector3;
    outHeading: number;
}

declare interface MpGamePathfindGetClosestVehicleWithHeading {
    outPosition: MpVector3;
    heading: number;
    unknown1: object;
}

declare interface MpGamePathfindGetRandomVehicle {
    outPosition: MpVector3;
    outHeading: number;
}

declare interface MpGamePathfindGenerateDirection {
    p4: number;
    vehicle: MpVehicle;
    p6: number;
}
