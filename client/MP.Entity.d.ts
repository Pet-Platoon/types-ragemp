...
declare interface MpEntity {
    ...
    getMatrix(rightVector: MpVector3, forwardVector: MpVector3, upVector: MpVector3, position: MpVector3): MpVectorMatrix;
    getHealth(): number;
...
declare interface MpVectorMatrix {
    rightVector: MpVector3;
    forwardVector: MpVector3;
    upVector: MpVector3;
    position: MpVector3;
}
