...
declare interface MpGameCam {
    ...
    setFollowPedCamViewMode(viewMode: MpCameraView | number): void;
    getGameplayCamRot(p0: number): MpVector3;
    createCamera(camHash: MpCameraName | number, p1: boolean): MpCamera;
    createCameraWithParams(camHash: MpCameraName | number, posX: number, posY: number, posZ: number, rotX: number, rotY: number, rotZ: number, fov: number, p8: boolean, p9: object): MpCamera;
    ...
    setFollowVehicleCamViewMode(viewMode: MpCameraView | number): void;
    getCamSplineNodeIndex(cam: number): boolean;
    setGameplayCamRelativeHeading(heading: number): void;
    createCamWithParams(camName: MpCameraName | string, posX: number, posY: number, posZ: number, rotX: number, rotY: number, rotZ: number, fov: number, p8: boolean, p9: object): MpCamera;
    createCam(camName: MpCameraName | string, p1: boolean): MpCamera;
    ...
    shakeCinematicCam(p0: MpCameraShake | string, p1: number): void;
    ...
    shakeGameplayGam(shakeName: MpCameraShake | string, intensity: number): void;
}
