...
declare interface MpVehicle extends MpEntity {
    ...
    getinterface(): MpVehicleVehicleinterface | number;
    ...
    getExtraColours(pearlescentColor: number, wheelColor: number): MpVehicleExtraColours;
    ...
    getNeonLightsColour(r: number, g: number, b: number): MpVehicleRgbColour;
    ...
    getModColor2(paintType: MpVehiclePaintType | number, color: number): MpVehicleModColor;
    setModColor2(paintType: MpVehiclePaintType | number, color: number): void;
    getCustomSecondaryColour(r: number, g: number, b: number): MpVehicleRgbColour;
    ...
    getColours(colorPrimary: number, colorSecondary: number): MpVehicleColour;
    ...
    getTyreSmokeColor(r: number, g: number, b: number): MpVehicleRgbColour;
    getCustomPrimaryColour(r: number, g: number, b: number): MpVehicleRgbColour;
    ...
    startAlarm(): void;
    getLightsState(lightsOn: boolean, highbeamsOn: boolean): MpVehicleLightsState;
    ...
    getModColor1(paintType: MpVehiclePaintType | number, color: number, p2: number): MpVehicleModColor;
    ...
    getColor(r: number, g: number, b: number): MpVehicleRgbColour;
...
interface MpVehicleLightsState {
    lightsOn: boolean;
    highbeamsOn: boolean;
}
...
interface MpVehicleModColor {
    paintType: MpVehiclePaintType | number;
    color: number;
    p2: number;
}
...
interface MpVehicleExtraColours {
...
declare enum MpVehicleVehicleinterface {
    compact = 0,
    sedan = 1,
    suv = 2,
    coupe = 3,
...
interface MpVehicleRandomVehicleModel {
    modelHash: number;
    p2: number;
}
