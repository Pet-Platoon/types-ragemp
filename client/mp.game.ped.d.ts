...
declare interface MpGamePed {
    ...
    clearRelationshipBetweenGroups(relationship: MpPedGroupRelationship, group1: string | number, group2: string | number): void;
    getNumParentPedsOfType(type: MpPedFaceType | number): number;
    ...
    getFirstParentIdForPedType(type: MpPedFaceType): number;
    ...
    getRandomPedAtCoord(x: number, y: number, z: number, xRadius: number, yRadius: number, zRadius: number, pedType: MpPedType): MpPed;
    ...
    getRelationshipBetweenGroups(group1: string | number, group2: string | number): MpPedGroupRelationship;
    getTattooZone(collection: string | number, overlay: string | number): MpPedTattooZoneData;
    ...
    setRelationshipBetweenGroups(relationship: MpPedGroupRelationship, group1: string | number, group2: string | number): void;
    getClosestPed(x: number, y: number, z: number, radius: number, p4: boolean, p5: boolean, outPed: MpPed, p7: boolean, p8: boolean, pedType: MpPedType): MpPed;
    ...
    createPed(pedType: MpPedType, modelHash: string | number, x: number, y: number, z: number, heading: number, networkHandle: boolean, pedHandle: boolean): MpPed;
